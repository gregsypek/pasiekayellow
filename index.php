...
<body>
        ...
        <ul class="header__slider-nav">
         ...
         <div class="header-text">
                ...
                <div class="header-bee">
                    <a href="#about">
                         <img src="img/new-bee.png" alt="bee-icon">
                    </a>
                </div>
        </div>
    </section>
    ...
    <section class="gallery m-top" id="gallery">
        ...
        <div class="hexagon hexagon-gallery-2">
            <img src="img/image.webp" alt="img-1">
        </div>
        <div class="hexagon hexagon-gallery-3">
            <img src="img/image2.webp" alt="img-2">
        </div>
    ...
    <section class="contact b-top" id="contact">
        ...
        <div class="contact-left">        
                ...
                <p class="contact-p left">Napisz do nas wiadomość</p>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-143937414-1"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-143937414-1');
    </script>
